...
const Footer = () => {
    return (
        <footer className={styleFooter.footer}>
            ...
            <a href="https://www.instagram.com/distribuidora_elrolo/?igshid=N2ZiY2E3YmU%3D"><img className={styleFooter.instagram} src="https://firebasestorage.googleapis.com/v0/b/distribuidora-84a8f.appspot.com/o/Instagram_logo.svg.png?alt=media&token=beca55ad-87f8-45f5-9083-f6a524a321d0" alt="link instagram" /></a>
