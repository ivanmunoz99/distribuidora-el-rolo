...
const Header = () =>{
    ...
    return (
        <div className={styleHeader.header}>
            <img className={styleHeader.logo} src="https://firebasestorage.googleapis.com/v0/b/distribuidora-84a8f.appspot.com/o/logo.png?alt=media&token=4e40843f-5ca5-409b-9895-1f1d995ba64b" alt="Logo distribuidora el rolo" />
